...
__global__ void A(double* localTensor, int n_ele, double dt, double* c0, double* CG1, double* d_CG1)
{
...
__global__ void d(double* localTensor, int n_ele, double dt, double* c0, double* d_CG1)
{
  const double CG1[3][6] = { {  0.09157621, 0.09157621, 0.81684757,
                               0.44594849, 0.44594849, 0.10810302 },
                             {  0.09157621, 0.81684757, 0.09157621,
...
__global__ void rhs(double* localTensor, int n_ele, double dt, double* c0, double* c1, double* CG1, double* d_CG1)
{
  const double CG1[3][6] = { {  0.09157621, 0.09157621, 0.81684757,
                               0.44594849, 0.44594849, 0.10810302 },
                             {  0.09157621, 0.81684757, 0.09157621,
