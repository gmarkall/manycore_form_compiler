    ...
    for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
    {
      for(int i_r_1 = 0; i_r_1 < 3; i_r_1++)
      {
        ...
        for(int i_g = 0; i_g < 6; i_g++)
        {
          ...
          double l1261[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
          double l1210[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
          for(int i_d_1 = 0; i_d_1 < 2; i_d_1++)
          {
            for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
            {
              for(int i_d_121 = 0; i_d_121 < 2; i_d_121++)
              {
                for(int i_d_126 = 0; i_d_126 < 2; i_d_126++)
                {
                  ST0 += c_q1[i_g][i_d_0][i_d_1] * -1 * (l1210[i_d_121][i_d_0] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_121] * (l1261[i_d_126][i_d_1] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_1][i_g][i_d_126];
                }
              }
            }
          }
          localTensor[i_ele + n_ele * (i_r_0 + 3 * i_r_1)] += (-1 * 0.5 * ST0 * ST1 + ST2) * w[i_g];
        }
      }
    }
  }
    ...
    for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
    {
      for(int i_r_1 = 0; i_r_1 < 3; i_r_1++)
      {
        ...
        for(int i_g = 0; i_g < 6; i_g++)
        {
          ...
          double l1161[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
          double l1110[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
          for(int i_d_1 = 0; i_d_1 < 2; i_d_1++)
          {
            for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
            {
              for(int i_d_111 = 0; i_d_111 < 2; i_d_111++)
              {
                for(int i_d_116 = 0; i_d_116 < 2; i_d_116++)
                {
                  ST7 += c_q1[i_g][i_d_0][i_d_1] * -1 * (l1110[i_d_111][i_d_0] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_111] * (l1161[i_d_116][i_d_1] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_1][i_g][i_d_116];
                }
              }
            }
          }
          localTensor[i_ele + n_ele * (i_r_0 + 3 * i_r_1)] += ST7 * ST8 * w[i_g];
        }
      }
    }
  }
  ...
  for(int i_ele = THREAD_ID; i_ele < n_ele; i_ele += THREAD_COUNT)
  {
    ...
    for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
    {
      ...
      for(int i_g = 0; i_g < 6; i_g++)
      {
        ...
        double l1061[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
        double l1010[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
        for(int i_d_1 = 0; i_d_1 < 2; i_d_1++)
        {
          for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
          {
            for(int i_d_101 = 0; i_d_101 < 2; i_d_101++)
            {
              for(int i_d_106 = 0; i_d_106 < 2; i_d_106++)
              {
                ST3 += c_q2[i_g][i_d_0][i_d_1] * -1 * (l1010[i_d_101][i_d_0] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_101] * (l1061[i_d_106][i_d_1] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_c_q1[i_g][i_d_106];
              }
            }
          }
        }
        localTensor[i_ele + n_ele * i_r_0] += (0.5 * ST3 * ST4 + ST5) * w[i_g];
      }
    }
  }
}
