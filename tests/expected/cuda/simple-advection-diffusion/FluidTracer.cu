    ...
    for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
    {
      for(int i_r_1 = 0; i_r_1 < 3; i_r_1++)
      {
        ...
        for(int i_g = 0; i_g < 6; i_g++)
        {
          ...
          {
            localTensor[i_ele + n_ele * (i_r_0 + 3 * i_r_1)] += -1 * 0.5 * d_CG1[i_ele + n_ele * (i_d_1 + 2 * (i_g + 6 * i_r_0))] * d_CG1[i_ele + n_ele * (i_d_1 + 2 * (i_g + 6 * i_r_1))] * 0.1 * -1 * dt * detwei[i_ele + n_ele * i_g];
          };
        };
      };
    };
    ...
    for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
    {
      for(int i_r_1 = 0; i_r_1 < 3; i_r_1++)
      {
        ...
        for(int i_g = 0; i_g < 6; i_g++)
        {
          for(int i_d_1 = 0; i_d_1 < 2; i_d_1++)
          {
            localTensor[i_ele + n_ele * (i_r_0 + 3 * i_r_1)] += d_CG1[i_ele + n_ele * (i_d_1 + 2 * (i_g + 6 * i_r_0))] * d_CG1[i_ele + n_ele * (i_d_1 + 2 * (i_g + 6 * i_r_1))] * 0.1 * -1 * dt * detwei[i_ele + n_ele * i_g];
          };
        };
      };
    };
  ...
  for(int i_ele = THREAD_ID; i_ele < n_ele; i_ele += THREAD_COUNT)
  {
    for(int i_g = 0; i_g < 6; i_g++)
    {
      ...
      for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
      {
        ...
        for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
        {
          d_c_q0[i_g + 6 * i_d_0] += c0[i_ele + n_ele * i_r_0] * d_CG1[i_ele + n_ele * (i_d_0 + 2 * (i_g + 6 * i_r_0))];
        };
      };
    };
    for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
    {
      ...
      for(int i_g = 0; i_g < 6; i_g++)
      {
        ...
        for(int i_d_1 = 0; i_d_1 < 2; i_d_1++)
        {
          localTensor[i_ele + n_ele * i_r_0] += 0.5 * d_CG1[i_ele + n_ele * (i_d_1 + 2 * (i_g + 6 * i_r_0))] * d_c_q0[i_g + 6 * i_d_1] * 0.1 * -1 * dt * detwei[i_ele + n_ele * i_g];
        };
      };
    };
  };
...
__global__ void adv_rhs(double* localTensor, int n_ele, double dt, double* detwei, double* c1, double* c0, double* CG1, double* d_CG1)
{
  double c_q1[6];
  double c_q0[12];
  for(int i_ele = THREAD_ID; i_ele < n_ele; i_ele += THREAD_COUNT)
  {
    ...
    for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
    {
      ...
      for(int i_g = 0; i_g < 6; i_g++)
      {
        ...
        for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
        {
          localTensor[i_ele + n_ele * i_r_0] += c_q1[i_g] * dt * c_q0[i_g + 6 * i_d_0] * d_CG1[i_ele + n_ele * (i_d_0 + 2 * (i_g + 6 * i_r_0))] * detwei[i_ele + n_ele * i_g];
        };
      };
    };
  };
...
extern "C" void run_model_(double* dt_pointer)
{
  ...
  matrix_addto<<<gridXDim,blockXDim>>>(t_adv_findrm, t_adv_colm, globalMatrix, eleNodes, localMatrix, numEle, 3);
  vector_addto<<<gridXDim,blockXDim>>>(globalVector, eleNodes, localVector, numEle, 3);
  ...
  expand_data<<<gridXDim,blockXDim>>>(t_advCoeff, solutionVector, eleNodes, numEle, state->getValsPerNode("t_adv"), 3);
  ...
  matrix_addto<<<gridXDim,blockXDim>>>(Tracer_findrm, Tracer_colm, globalMatrix, eleNodes, localMatrix, numEle, 3);
  vector_addto<<<gridXDim,blockXDim>>>(globalVector, eleNodes, localVector, numEle, 3);
  cg_solve(Tracer_findrm, Tracer_findrm_size, Tracer_colm, Tracer_colm_size, globalMatrix, globalVector, numNodes, solutionVector);
  expand_data<<<gridXDim,blockXDim>>>(TracerCoeff, solutionVector, eleNodes, numEle, state->getValsPerNode("Tracer"), 3);
