    ...
    for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
    {
      for(int i_r_1 = 0; i_r_1 < 3; i_r_1++)
      {
        ...
        for(int i_g = 0; i_g < 6; i_g++)
        {
          ...
          ST1 += 0.1 * -1 * dt;
          double l9596[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
          double l9096[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
          for(int i_d_96 = 0; i_d_96 < 2; i_d_96++)
          {
            for(int i_d_90 = 0; i_d_90 < 2; i_d_90++)
            {
              for(int i_d_95 = 0; i_d_95 < 2; i_d_95++)
              {
                ST0 += (l9096[i_d_90][i_d_96] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_90] * (l9596[i_d_95][i_d_96] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_1][i_g][i_d_95];
              }
            }
          }
    ...
    for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
    {
      for(int i_r_1 = 0; i_r_1 < 3; i_r_1++)
      {
        ...
        for(int i_g = 0; i_g < 6; i_g++)
        {
          ...
          ST13 += 0.1 * -1 * dt;
          double l7879[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
          double l7379[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
          for(int i_d_79 = 0; i_d_79 < 2; i_d_79++)
          {
            for(int i_d_73 = 0; i_d_73 < 2; i_d_73++)
            {
              for(int i_d_78 = 0; i_d_78 < 2; i_d_78++)
              {
                ST12 += (l7379[i_d_73][i_d_79] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_73] * (l7879[i_d_78][i_d_79] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_1][i_g][i_d_78];
              }
            }
          }
  ...
  for(int i_ele = THREAD_ID; i_ele < n_ele; i_ele += THREAD_COUNT)
  {
    ...
    for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
    {
      ...
      for(int i_g = 0; i_g < 6; i_g++)
      {
        ...
        ST5 += 0.1 * -1 * dt;
        double l6768[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
        double l6268[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
        for(int i_d_68 = 0; i_d_68 < 2; i_d_68++)
        {
          for(int i_d_62 = 0; i_d_62 < 2; i_d_62++)
          {
            for(int i_d_67 = 0; i_d_67 < 2; i_d_67++)
            {
              ST4 += (l6268[i_d_62][i_d_68] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_62] * (l6768[i_d_67][i_d_68] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_c_q1[i_g][i_d_67];
            }
          }
        }
  ...
  for(int i_ele = THREAD_ID; i_ele < n_ele; i_ele += THREAD_COUNT)
  {
    ...
    for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
    {
      ...
      for(int i_g = 0; i_g < 6; i_g++)
      {
        ...
        double l8485[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
        ST10 += c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0];
        for(int i_d_85 = 0; i_d_85 < 2; i_d_85++)
        {
          for(int i_d_84 = 0; i_d_84 < 2; i_d_84++)
          {
            ST9 += c_q1[i_g][i_d_85] * (l8485[i_d_84][i_d_85] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_84];
          }
        }
...
extern "C" void run_model_(double* dt_pointer)
{
  ...
  matrix_addto<<<gridXDim,blockXDim>>>(t_adv_findrm, t_adv_colm, globalMatrix, 
                                       eleNodes, localMatrix, numEle, 
                                       nodesPerEle);
