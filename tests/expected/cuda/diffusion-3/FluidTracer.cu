        ...
        for(int i_g = 0; i_g < 6; i_g++)
        {
          ...
          for(int i_d_5 = 0; i_d_5 < 2; i_d_5++)
          {
            for(int i_d_3 = 0; i_d_3 < 2; i_d_3++)
            {
              ...
              {
                localTensor[i_ele + n_ele * (i_r_0 + 3 * i_r_1)] += -1 * 0.5 * (l35[i_d_3][i_d_5] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_3] * (l95[i_d_9][i_d_5] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_1][i_g][i_d_9] * 0.1 * -1 * dt * (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0]) * w[i_g];
              };
            };
          };
        };
        ...
        for(int i_g = 0; i_g < 6; i_g++)
        {
          ...
          for(int i_d_5 = 0; i_d_5 < 2; i_d_5++)
          {
            for(int i_d_3 = 0; i_d_3 < 2; i_d_3++)
            {
              for(int i_d_9 = 0; i_d_9 < 2; i_d_9++)
              {
                localTensor[i_ele + n_ele * (i_r_0 + 3 * i_r_1)] += (l35[i_d_3][i_d_5] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_3] * (l95[i_d_9][i_d_5] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_1][i_g][i_d_9] * 0.1 * -1 * dt * (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0]) * w[i_g];
              };
            };
          };
        };
      ...
      for(int i_g = 0; i_g < 6; i_g++)
      {
        ...
        for(int i_d_5 = 0; i_d_5 < 2; i_d_5++)
        {
          for(int i_d_3 = 0; i_d_3 < 2; i_d_3++)
          {
            for(int i_d_9 = 0; i_d_9 < 2; i_d_9++)
            {
              localTensor[i_ele + n_ele * i_r_0] += 0.5 * (l35[i_d_3][i_d_5] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_3] * (l95[i_d_9][i_d_5] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_c_q1[i_g][i_d_9] * 0.1 * -1 * dt * (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0]) * w[i_g];
            };
          };
        };
      };
