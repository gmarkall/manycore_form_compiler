...
__global__ void L(double* localTensor, int n_ele, double dt, double* detwei, double* c0, double* CG1)
{
  double c_q0[6];
  for(int i_ele = THREAD_ID; i_ele < n_ele; i_ele += THREAD_COUNT)
  {
...
extern "C" void run_model_(double* dt_pointer)
{
  ...
  L<<<gridXDim,blockXDim>>>(localVector, numEle, dt, detwei, TracerCoeff, shape);
