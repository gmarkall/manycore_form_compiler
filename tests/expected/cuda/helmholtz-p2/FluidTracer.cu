...
extern "C" void run_model_(double* dt_pointer)
{
  ...
  matrix_dump(Tracer_findrm, Tracer_colm, globalMatrix, Tracer_findrm_size, Tracer_colm_size, "A.mtx");
  ...
  vector_dump(localVector, Tracer_numEle*Tracer_nodesPerEle, "b_local.mtx");
  ...
  vector_dump(globalVector, Tracer_numNodes, "b.mtx");
  ...
  vector_dump(solutionVector, Tracer_numNodes, "x.mtx");
