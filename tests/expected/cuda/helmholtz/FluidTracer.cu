    ...
    for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
    {
      for(int i_r_1 = 0; i_r_1 < 3; i_r_1++)
      {
        ...
        for(int i_g = 0; i_g < 6; i_g++)
        {
          for(int i_d_1 = 0; i_d_1 < 2; i_d_1++)
          {
            localTensor[i_ele + n_ele * (i_r_0 + 3 * i_r_1)] += (d_CG1[i_d_1][i_r_0][i_g] * d_CG1[i_d_1][i_r_1][i_g] + -1 * CG1[i_r_0][i_g] * CG1[i_r_1][i_g]) * (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0]) * w[i_g];
          };
        };
      };
    };
