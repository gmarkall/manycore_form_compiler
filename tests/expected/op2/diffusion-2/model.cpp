    ...
    for(int i_r_1 = 0; i_r_1 < 3; i_r_1++)
    {
      ...
      for(int i_g = 0; i_g < 6; i_g++)
      {
        ...
        for(int i_d_3 = 0; i_d_3 < 2; i_d_3++)
        {
          for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
          {
            localTensor[i_r_0][i_r_1] += -1 * 0.5 * -1 * c_q1[i_g][i_d_0][i_d_1] * d_CG1[i_d_0][i_r_0][i_g] * d_CG1[i_d_3][i_r_1][i_g] * (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0]) * w[i_g];
          };
        };
      };
    };
    ...
    for(int i_r_1 = 0; i_r_1 < 3; i_r_1++)
    {
      ...
      for(int i_g = 0; i_g < 6; i_g++)
      {
        for(int i_d_3 = 0; i_d_3 < 2; i_d_3++)
        {
          for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
          {
            localTensor[i_r_0][i_r_1] += -1 * c_q1[i_g][i_d_0][i_d_1] * d_CG1[i_d_0][i_r_0][i_g] * d_CG1[i_d_3][i_r_1][i_g] * (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0]) * w[i_g];
          };
        };
      };
    };
  ...
  for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
  {
    ...
    for(int i_g = 0; i_g < 6; i_g++)
    {
      ...
      for(int i_d_3 = 0; i_d_3 < 2; i_d_3++)
      {
        for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
        {
          localTensor[i_r_0] += 0.5 * -1 * c_q2[i_g][i_d_0][i_d_1] * d_CG1[i_d_0][i_r_0][i_g] * d_c_q1[i_d_3][i_g] * (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0]) * w[i_g];
        };
      };
    };
  };
