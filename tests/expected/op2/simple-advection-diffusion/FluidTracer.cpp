...
void A_0(double* localTensor, double* dt, double* c0[2], int i_r_0, int i_r_1)
{
  ...
  for(int i_g = 0; i_g < 6; i_g++)
  {
    ...
    ST1 += 0.1 * -1 * *dt;
    double l272273[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
    double l267273[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
    for(int i_d_273 = 0; i_d_273 < 2; i_d_273++)
    {
      for(int i_d_267 = 0; i_d_267 < 2; i_d_267++)
      {
        for(int i_d_272 = 0; i_d_272 < 2; i_d_272++)
        {
          ST0 += (l267273[i_d_267][i_d_273] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_267] * (l272273[i_d_272][i_d_273] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_1][i_g][i_d_272];
        }
      }
    }
...
void d_0(double* localTensor, double* dt, double* c0[2], int i_r_0, int i_r_1)
{
  ...
  for(int i_g = 0; i_g < 6; i_g++)
  {
    ...
    ST13 += 0.1 * -1 * *dt;
    double l255256[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
    double l250256[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
    for(int i_d_256 = 0; i_d_256 < 2; i_d_256++)
    {
      for(int i_d_250 = 0; i_d_250 < 2; i_d_250++)
      {
        for(int i_d_255 = 0; i_d_255 < 2; i_d_255++)
        {
          ST12 += (l250256[i_d_250][i_d_256] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_250] * (l255256[i_d_255][i_d_256] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_1][i_g][i_d_255];
        }
      }
    }
...
void diff_rhs_0(double** localTensor, double* dt, double* c0[2], double* c1[1])
{
  ...
  for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
  {
    for(int i_g = 0; i_g < 6; i_g++)
    {
      ...
      ST5 += 0.1 * -1 * *dt;
      double l244245[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
      double l239245[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
      for(int i_d_245 = 0; i_d_245 < 2; i_d_245++)
      {
        for(int i_d_239 = 0; i_d_239 < 2; i_d_239++)
        {
          for(int i_d_244 = 0; i_d_244 < 2; i_d_244++)
          {
            ST4 += (l239245[i_d_239][i_d_245] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_239] * (l244245[i_d_244][i_d_245] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_c_q1[i_g][i_d_244];
          }
        }
      }
...
void adv_rhs_0(double** localTensor, double* dt, double* c0[2], double* c1[2], double* c2[1])
{
  ...
  for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
  {
    for(int i_g = 0; i_g < 6; i_g++)
    {
      ...
      double l261262[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
      ST10 += c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0];
      for(int i_d_262 = 0; i_d_262 < 2; i_d_262++)
      {
        for(int i_d_261 = 0; i_d_261 < 2; i_d_261++)
        {
          ST9 += c_q1[i_g][i_d_262] * (l261262[i_d_261][i_d_262] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_261];
        }
      }
