      ...
      for(int i_g = 0; i_g < 6; i_g++)
      {
        ...
        for(int i_d_5 = 0; i_d_5 < 2; i_d_5++)
        {
          for(int i_d_3 = 0; i_d_3 < 2; i_d_3++)
          {
            ...
            {
              localTensor[i_r_0][i_r_1] += (l35[i_d_3][i_d_5] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_d_3][i_r_0][i_g] * (l95[i_d_9][i_d_5] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_d_9][i_r_1][i_g] * (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0]) * w[i_g];
            };
          };
        };
      };
