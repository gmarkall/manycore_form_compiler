...
void A_0(double* localTensor, double* dt, double* c0[2], int i_r_0, int i_r_1)
{
  ...
  for(int i_g = 0; i_g < 6; i_g++)
  {
    ...
    double l352353[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
    double l347353[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
    for(int i_d_353 = 0; i_d_353 < 2; i_d_353++)
    {
      for(int i_d_347 = 0; i_d_347 < 2; i_d_347++)
      {
        for(int i_d_352 = 0; i_d_352 < 2; i_d_352++)
        {
          ST0 += (l347353[i_d_347][i_d_353] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_347] * (l352353[i_d_352][i_d_353] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_1][i_g][i_d_352];
        }
      }
    }
