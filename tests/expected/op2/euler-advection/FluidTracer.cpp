...
void rhs_0(double** localTensor, double* dt, double* c0[2], double* c1[1], double* c2[2])
{
  ...
  for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
  {
    for(int i_g = 0; i_g < 6; i_g++)
    {
      ...
      double l200201[2][2] = { { c_q0[i_g][1][1], -1 * c_q0[i_g][0][1] }, { -1 * c_q0[i_g][1][0], c_q0[i_g][0][0] } };
      ST2 += c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0];
      for(int i_d_201 = 0; i_d_201 < 2; i_d_201++)
      {
        for(int i_d_200 = 0; i_d_200 < 2; i_d_200++)
        {
          ST1 += c_q2[i_g][i_d_201] * (l200201[i_d_200][i_d_201] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_200];
        }
      }
