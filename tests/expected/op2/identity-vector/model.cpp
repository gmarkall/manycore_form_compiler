...
void A(double localTensor[6][6], double dt)
{
  ...
  for(int i_r_0 = 0; i_r_0 < 6; i_r_0++)
  {
    for(int i_r_1 = 0; i_r_1 < 6; i_r_1++)
    {
      ...
      for(int i_g = 0; i_g < 6; i_g++)
      {
        ...
        {
          localTensor[i_r_0][i_r_1] += CG1_v[i_d_0][i_r_0][i_g] * CG1_v[i_d_0][i_r_1][i_g] * detwei[i_g];
        };
      };
    };
  };
...
void RHS(double localTensor[6], double dt, double c0[3][2])
{
  const double CG1[3][6] = { {  0.09157621, 0.09157621, 0.81684757,
                               0.44594849, 0.44594849, 0.10810302 },
                             {  0.09157621, 0.81684757, 0.09157621,
  ...
  for(int i_r_0 = 0; i_r_0 < 6; i_r_0++)
  {
    ...
    for(int i_g = 0; i_g < 6; i_g++)
    {
      for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
      {
        localTensor[i_r_0] += CG1_v[i_d_0][i_r_0][i_g] * c_q0[i_g][i_d_0] * detwei[i_g];
      };
    };
  };
}
