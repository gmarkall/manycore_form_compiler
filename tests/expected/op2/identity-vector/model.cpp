  ...
  for(int i_r_0 = 0; i_r_0 < 6; i_r_0++)
  {
    for(int i_r_1 = 0; i_r_1 < 6; i_r_1++)
    {
      ...
      for(int i_g = 0; i_g < 6; i_g++)
      {
        for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
        {
          localTensor[i_r_0][i_r_1] += CG1_v[i_d_0][i_r_0][i_g] * CG1_v[i_d_0][i_r_1][i_g] * (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0]) * w[i_g];
        };
      };
    };
  };
...
void RHS(double localTensor[6], double dt, double c0[3][2], double c1[3][2])
{
  ...
  for(int i_r_0 = 0; i_r_0 < 6; i_r_0++)
  {
    ...
    for(int i_g = 0; i_g < 6; i_g++)
    {
      for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
      {
        localTensor[i_r_0] += CG1_v[i_d_0][i_r_0][i_g] * c_q1[i_g][i_d_0] * (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0]) * w[i_g];
      };
    };
  };
}
