        ...
        for(int i_d_1 = 0; i_d_1 < 2; i_d_1++)
        {
          for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
          {
            for(int i_d_5 = 0; i_d_5 < 2; i_d_5++)
            {
              ...
              {
                localTensor[i_r_0][i_r_1] += -1 * 0.5 * c_q1[i_g][i_d_0][i_d_1] * -1 * (l50[i_d_5][i_d_0] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_5] * (l101[i_d_10][i_d_1] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_1][i_g][i_d_10] * (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0]) * w[i_g];
              };
            };
          };
        };
        ...
        for(int i_d_1 = 0; i_d_1 < 2; i_d_1++)
        {
          for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
          {
            for(int i_d_5 = 0; i_d_5 < 2; i_d_5++)
            {
              for(int i_d_10 = 0; i_d_10 < 2; i_d_10++)
              {
                localTensor[i_r_0][i_r_1] += c_q1[i_g][i_d_0][i_d_1] * -1 * (l50[i_d_5][i_d_0] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_5] * (l101[i_d_10][i_d_1] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_1][i_g][i_d_10] * (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0]) * w[i_g];
              };
            };
          };
        };
      ...
      for(int i_d_1 = 0; i_d_1 < 2; i_d_1++)
      {
        for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
        {
          for(int i_d_5 = 0; i_d_5 < 2; i_d_5++)
          {
            for(int i_d_10 = 0; i_d_10 < 2; i_d_10++)
            {
              localTensor[i_r_0] += 0.5 * c_q2[i_g][i_d_0][i_d_1] * -1 * (l50[i_d_5][i_d_0] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_CG1[i_r_0][i_g][i_d_5] * (l101[i_d_10][i_d_1] / (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0])) * d_c_q1[i_g][i_d_10] * (c_q0[i_g][0][0] * c_q0[i_g][1][1] + -1 * c_q0[i_g][0][1] * c_q0[i_g][1][0]) * w[i_g];
            };
          };
        };
      };
