...
extern "C" void initialise_rose_()
{
  ...
  op_dat TracerDiffusivity = op_decl_dat(TracerDiffusivity_dofs, 4, "double", (double*)(0), 
              "TracerDiffusivity");
...
extern "C" void run_model_(double* dt_pointer)
{
  ...
  op_field_struct TracerDiffusivity_field;
  op_map TracerDiffusivity_element_dofs;
  op_dat TracerDiffusivity;
  TracerDiffusivity_field = extract_op_tensor_field(state, "TracerDiffusivity", 17, 0);
  TracerDiffusivity_element_dofs = TracerDiffusivity_field.map;
  TracerDiffusivity = TracerDiffusivity_field.dat;
  ...
  op_par_loop(A_0, "A_0", op_iteration_space(Coordinate_elements, 3, 3), 
              ...
              op_arg_dat(Coordinate, OP_ALL, Coordinate_element_dofs, 2, 
                         "double", OP_READ), 
              op_arg_dat(TracerDiffusivity, OP_ALL, 
                         TracerDiffusivity_element_dofs, 2, "double", OP_READ));
