    ...
    for(int i_r_0 = 0; i_r_0 < 3; i_r_0++)
    {
      ...
      for(int i_g = 0; i_g < 6; i_g++)
      {
        ...
        for(int i_d_0 = 0; i_d_0 < 2; i_d_0++)
        {
          for(int i_d_1 = 0; i_d_1 < 2; i_d_1++)
          {
            localTensor[(i_ele + (n_ele * i_r_0))] += ((0.5 * (-1 * ((c_q1[((i_g + (6 * i_d_0)) + (2 * (6 * i_d_1)))] * d_CG1[(((i_ele + (n_ele * i_d_1)) + (2 * (n_ele * i_g))) + (6 * (2 * (n_ele * i_r_0))))]) * d_c_q0[(((i_ele + (n_ele * i_d_0)) + (2 * (n_ele * i_g))) + (6 * (2 * (n_ele * i_r_0))))]))) * detwei[(i_ele + (n_ele * i_g))]);
          };
        };
      };
    };
